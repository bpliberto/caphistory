...
options(warn=0) ##This hides warnings, again, just really for knitting. Can be turned back on with warn=0
```
...
model23=crm(marked_dfNMBS,  
          time.intervals = c(23, 4, 9, 2, 4, 15, 9, 1, 2, 7, 9),
          groups = c("species.fac"), 
          model.parameters=list(p = list(formula = ~1), Phi = list(formular = ~1)))
