...
mod1<-glm(adjusted.abundance~pH, data= dataA, family = poisson(link="log"))
mod2<-glm(adjusted.abundance~elevation, data= dataA,family = poisson(link="log"))
mod3<-glm(adjusted.abundance~fishpresence, data= dataA,family = poisson(link="log"))
mod4<-glm(adjusted.abundance~lenticlotic,data= dataA, family = poisson(link="log"))  
mod5<-glm(adjusted.abundance~openwater, data= dataA,family = poisson(link="log"))
mod6<-glm(adjusted.abundance~pH*elevation, data= dataA,family = poisson(link="log"))
mod7<-glm(adjusted.abundance~pH*elevation*fishpresence,data= dataA, family = poisson(link="log"))
mod8<-glm(adjusted.abundance~pH*elevation*fishpresence*lenticlotic,data= dataA, family = poisson(link="log"))
mod9<-glm(adjusted.abundance~pH*elevation*fishpresence*lenticlotic*openwater,data= dataA, family = poisson(link="log"))
mod10<-glm(adjusted.abundance~elevation*fishpresence,data= dataA, family = poisson(link="log"))
mod11<-glm(adjusted.abundance~elevation*fishpresence*lenticlotic, data= dataA,family = poisson(link="log"))
mod12<-glm(adjusted.abundance~elevation*fishpresence*lenticlotic*openwater, data= dataA,family = poisson(link="log"))
mod13<-glm(adjusted.abundance~fishpresence*lenticlotic, data= dataA,family = poisson(link="log"))
mod14<-glm(adjusted.abundance~fishpresence*openwater,data= dataA, family = poisson(link="log")) #### Chicken dinner  #####
mod15<-glm(adjusted.abundance~fishpresence*lenticlotic*openwater, data= dataA,family = poisson()) #### Almost the same ####
mod16<-glm(adjusted.abundance~lenticlotic*openwater, data= dataA,family = poisson(link="log"))
mod17<-glm(adjusted.abundance~pH*openwater,data= dataA, family = poisson(link="log"))
...
"lenticlotic",
"openwater",
"pH elevation fish lenticlotic openwater")
# makde AIC table
