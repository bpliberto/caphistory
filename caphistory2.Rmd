...
modA7<-glm(Richness  ~  pH, data= dataA, family = poisson(link="log"))
modA8<-glm(Richness ~ elevation, data= dataA,family = poisson(link="log"))
modA9<-glm(Richness ~ fishpresence, data= dataA,family = poisson(link="log"))
modA10<-glm(Richness ~ lenticlotic,data= dataA, family = poisson(link="log"))  
modA11<-glm(Richness ~ openwater, data= dataA,family = poisson(link="log"))
modA12<-glm(Richness ~ pH*elevation*fishpresence*lenticlotic*openwater,data= dataA, family = poisson(link="log"))

# make list of models
modelsA <- list(modA1, modA2, modA2, modA4, modA5, modA6)
# names of models
mod_namesA <- c("pH",
"elevation",
"fish",
