...
```{r}
library(ggplot2)
adultabund <- ggplot(dataA, aes(x=openwater, y=adjusted.abundance)) + geom_point() #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
adultabund + 
...
adultrich <- ggplot(dataA, aes(x=openwater, y=Richness)) + geom_point() #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
adultrich + 
  geom_label_repel(aes(label = ID),
                  box.padding   = 0.35, 
                  point.padding = 0.5,
...
library(ggplot2)
library(ggrepel)
nymphabund <- ggplot(dataB, aes(x=openwatersizem2, y=abundance)) + geom_point() #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
...
nymphrich <- ggplot(dataB, aes(x=openwatersizem2, y=richness)) + geom_point() #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
nymphrich + 
  geom_label_repel(aes(label = ID),
                  box.padding   = 0.35, 
                  point.padding = 0.5,
