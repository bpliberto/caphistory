...
mod1<-glm(dataA$adjusted.abundance~dataA$pH)
mod2<-glm(dataA$adjusted.abundance~dataA$elevation)
mod3<-glm(dataA$adjusted.abundance~dataA$fishpresence)
mod4<-glm(dataA$adjusted.abundance~dataA$lenticlotic)  
mod5<-glm(dataA$adjusted.abundance~dataA$openwater)
mod6<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation)
mod7<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation*dataA$fishpresence)
mod8<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation*dataA$fishpresence*dataA$lenticlotic)
mod9<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation*dataA$fishpresence*dataA$lenticlotic*dataA$openwater) 
mod10<-glm(dataA$adjusted.abundance~dataA$elevation*dataA$fishpresence)
mod11<-glm(dataA$adjusted.abundance~dataA$elevation*dataA$fishpresence*dataA$lenticlotic)
mod12<-glm(dataA$adjusted.abundance~dataA$elevation*dataA$fishpresence*dataA$lenticlotic*dataA$openwater)
mod13<-glm(dataA$adjusted.abundance~dataA$fishpresence*dataA$lenticlotic)
mod14<-glm(dataA$adjusted.abundance~dataA$fishpresence*dataA$openwater) #### Chicken dinner  #####
mod15<-glm(dataA$adjusted.abundance~dataA$fishpresence*dataA$lenticlotic*dataA$openwater) #### Almost the same ####
mod16<-glm(dataA$adjusted.abundance~dataA$lenticlotic*dataA$openwater)
mod17<-glm(dataA$adjusted.abundance~dataA$pH*dataA$openwater)
...
AIC(mod15) #### Almost the same, 0.1258 difference ####
AIC(mod16)
AIC(mod17)
...
### Each possible combination of variables needs to be analyzed.  The lowest score (not counting the full model?) wins. #####
mod1<-glm(data$abundance~data$p + offset(data$Area.sampled))#poisson distribution,hav e family= posisson
