...
modA14 <- glm(Abundance ~ pH + lenticlotic,data= dataA, family = poisson(link="log"), offset(adulteffort))
...
modAR14<- glm(Richness ~  pH + lenticlotic,data= dataA, family = poisson(link="log"), offset(adulteffort))

# make list of models
modelsA <- list(modA7, modA8, modA9, modA11, modA12, modA14)
# names of models
mod_namesA <- c(  "y=1",
"pH-fish",
"pH-openwater",
...
# make list of models
modelsAR <- list(modAR7, modAR8, modAR9, modAR11, modAR12, modAR14)
# names of models
mod_namesAR <- c("y=1",
"pH-fish",
"pH-openwater",
...
modB14 <-glm(abundance ~ pH +lenticlotic, data= dataB, family = poisson(link="log"), offset(areasampled))
modB15 <-glm(abundance ~ pH +lenticlotic + fishpresence, data= dataB, family = poisson(link="log"), offset(areasampled))
...
modBR13 <- glm(richness ~  conductivity, data= dataB, family = poisson(link="log"), offset(areasampled))
...
modBR14 <-glm(richness ~ pH +lenticlotic, data= dataB, family = poisson(link="log"), offset(areasampled))
modBR15 <-glm(richness ~ pH +lenticlotic + fishpresence, data= dataB, family = poisson(link="log"), offset(areasampled))
...
# make list of models
modelsB <- list(modB7, modB8, modB9, modB10, modB12, modB14, modB15)
# names of models
...
# make list of models
modelsBR <- list(modBR7, modBR8,modBR9, modBR10, modBR12, modBR14, modBR15)
# names of models
