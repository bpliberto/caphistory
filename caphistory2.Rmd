...
```{r}
library(ggplot2)
ggplot(dataA, aes(x=openwater, y=adjusted.abundance)) + geom_point()

ggplot(dataA, aes(x=openwater, y=Richness)) + geom_point()
```
...
```{r}
library(ggplot2)
ggplot(dataB, aes(x=openwatersizem2, y=abundance)) + geom_point()

ggplot(dataB, aes(x=openwatersizem2, y=richness)) + geom_point()
```
