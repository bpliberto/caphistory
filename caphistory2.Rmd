...
# make list of models
modelsA <- list(modA2,modA7, modA8, modA9, modA11, modA12, modA13)
# names of models
...
# make list of models
modelsAR <- list(modAR2, modAR7, modAR8, modAR9, modAR11, modAR12, modAR13)
# names of models
...
library(rsq)
rsq(modAR13,adj=FALSE,type=c('v','kl','sse','lr','n'),data=dataA) #this is supposed to give me the r^2 values for glms
...
###simple
# make list of models
modelsB <- list( modB1, modB2, modB3,modB4, modB5, modB11)
# names of models
mod_namesB <- c("ph",
                "elevation",
                "fish",
...
###simple
# make list of models
modelsBR <- list( modBR1, modBR2, modBR3,modBR4, modBR5, modBR11)
# names of models
mod_namesBR <- c("ph",
                "elevation",
                "fish",
