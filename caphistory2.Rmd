...
adultrecap <- ggplot(dataD, aes(x=openwatersize, y=percentrecap)) + geom_point() + scale_y_continuous(labels=scales::percent)+ xlab("Area of Open Water" ~(m^2)) + ylab("Percent Recaptured") +theme_bw()
adultrecap
```
