...
modA6<-glm(Abundance ~ pH + elevation + fishpresence + lenticlotic + openwater,data= dataA, family = poisson(link="log"), offset(adulteffort))
...
modAR6<-glm(Richness ~ pH*elevation*fishpresence*lenticlotic*openwater,data= dataA, family = poisson(link="log"), offset(adulteffort))
modAR7<-glm(Richness ~ 1,data= dataA, family = poisson(link="log"))

# make list of models
modelsA <- list(modA1, modA2, modA2, modA4, modA5, modA6, modA7, modA8)
# names of models
mod_namesA <- c("pH",
"elevation",
"fish",
