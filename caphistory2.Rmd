...
nymphabundt <- ggplot(dataB, aes(x=averagewatertemp, y=adjusted.abundance)) + geom_point() + xlab("Elevation (m)") + ylab("Nymph Abundance") 
nymphricht <- ggplot(dataB, aes(x=averagewatertemp, y=adjusted.richness)) + geom_point() + xlab("Elevation (m)") + ylab("Nymph Richness")
