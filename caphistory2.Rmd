...
modA9<-glm(adjusted.abundance ~ pH*elevation*fishpresence*lenticlotic*openwater,data= dataA, family = poisson(link="log"))




# make list of models
modelsA <- list(modA1, modA2, modA2, modA4, modA5, modA9)
# names of models
mod_namesA <- c("pH",
"elevation",
"fish",
...
### Each possible combination of variables needs to be analyzed.  The lowest score (not counting the full model?) wins. #####
modB1<-glm(abundance ~ pH + offset(data$Area.sampled), data= dataB, family = poisson(link="log"))
modB2<-glm(abundance ~ elevation + offset(data$Area.sampled), data= dataB, family = poisson(link="log"))
modB3<-glm(abundance ~ fishpresence + offset(data$Area.sampled), data= dataB, family = poisson(link="log"))
modB4<-glm(abundance ~ lenticlotic + offset(data$Area.sampled), data= dataB, family = poisson(link="log"))
modB5<-glm(abundance ~ openwatersizem2 + offset(data$Area.sampled), data= dataB, family = poisson(link="log"))
modB9<-glm(abundance ~ pH*elevation*fishpresence*lenticlotic*openwatersizem2 + offset(data$Area.sampled), data= dataB, family = poisson(link="log"))

# make list of models
modelsB <- list(modB1, modB2, modB2, modB4, modB5, modB9)
# names of models
mod_namesB <- c("pH",
"elevation",
"fish",
