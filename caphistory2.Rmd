...
mod1<-glm(dataA$adjusted.abundance~dataA$pH, family = poisson())
mod2<-glm(dataA$adjusted.abundance~dataA$elevation, family = poisson())
mod3<-glm(dataA$adjusted.abundance~dataA$fishpresence, family = poisson())
mod4<-glm(dataA$adjusted.abundance~dataA$lenticlotic, family = poisson())  
mod5<-glm(dataA$adjusted.abundance~dataA$openwater, family = poisson())
mod6<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation, family = poisson())
mod7<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation*dataA$fishpresence, family = poisson())
mod8<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation*dataA$fishpresence*dataA$lenticlotic, family = poisson())
mod9<-glm(dataA$adjusted.abundance~dataA$pH*dataA$elevation*dataA$fishpresence*dataA$lenticlotic*dataA$openwater, family = poisson())
mod10<-glm(dataA$adjusted.abundance~dataA$elevation*dataA$fishpresence, family = poisson())
mod11<-glm(dataA$adjusted.abundance~dataA$elevation*dataA$fishpresence*dataA$lenticlotic, family = poisson())
mod12<-glm(dataA$adjusted.abundance~dataA$elevation*dataA$fishpresence*dataA$lenticlotic*dataA$openwater, family = poisson())
mod13<-glm(dataA$adjusted.abundance~dataA$fishpresence*dataA$lenticlotic, family = poisson())
mod14<-glm(dataA$adjusted.abundance~dataA$fishpresence*dataA$openwater, family = poisson()) #### Chicken dinner  #####
mod15<-glm(dataA$adjusted.abundance~dataA$fishpresence*dataA$lenticlotic*dataA$openwater, family = poisson()) #### Almost the same ####
mod16<-glm(dataA$adjusted.abundance~dataA$lenticlotic*dataA$openwater, family = poisson())
mod17<-glm(dataA$adjusted.abundance~dataA$pH*dataA$openwater, family = poisson())



# make list of models
modelsA <- list(mod1, mod2, mod2, mod4, mod5, mod9)
# names of models
mod_namesA <- c("pH",
"elevation",
"fish",
"lenticlotic",
"openwater",
"elevation fish lenticlotic openwater")
# makde AIC table
...
```{r}
library(ggplot2)
adultabund <- ggplot(dataA, aes(x=openwater, y=adjusted.abundance)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Abundance") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
adultabund + 
...
adultrich <- ggplot(dataA, aes(x=openwater, y=Richness)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Richness") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
adultrich + 
  geom_label_repel(aes(label = ID),
                  box.padding   = 0.35, 
                  point.padding = 0.5,
...
AIC(mod1)  ### k = 2 is the "penalty" for adding more factors #####
AIC(mod2)
AIC(mod3)
AIC(mod4) #### Chicken dinner  #####
AIC(mod5)
AIC(mod6)
AIC(mod7)
AIC(mod8)
...
### Each possible combination of variables needs to be analyzed.  The lowest score (not counting the full model?) wins. #####
mod1<-glm(dataB$abundance~dataB$pH)
mod2<-glm(dataB$abundance~dataB$elevation)
mod3<-glm(dataB$abundance~dataB$fishpresence)
mod4<-glm(dataB$abundance~dataB$lenticlotic)  
mod5<-glm(dataB$abundance~dataB$openwater)
mod6<-glm(dataB$abundance~dataB$pH*dataB$elevation)
mod7<-glm(dataB$abundance~dataB$pH*dataB$elevation*dataB$fishpresence)
mod8<-glm(dataB$abundance~dataB$pH*dataB$elevation*dataB$fishpresence*dataB$lenticlotic)
mod9<-glm(dataB$abundance~dataB$pH*dataB$elevation*dataB$fishpresence*dataB$lenticlotic*dataB$openwater) 
mod10<-glm(dataB$abundance~dataB$elevation*dataB$fishpresence)
mod11<-glm(dataB$abundance~dataB$elevation*dataB$fishpresence*dataB$lenticlotic)
mod12<-glm(dataB$abundance~dataB$elevation*dataB$fishpresence*dataB$lenticlotic*dataB$openwater)
mod13<-glm(dataB$abundance~dataB$fishpresence*dataB$lenticlotic)
mod14<-glm(dataB$abundance~dataB$fishpresence*dataB$openwater) #### Chicken dinner  #####
mod15<-glm(dataB$abundance~dataB$fishpresence*dataB$lenticlotic*dataB$openwater) #### Almost the same ####
mod16<-glm(dataB$abundance~dataB$lenticlotic*dataB$openwater)
mod17<-glm(dataB$abundance~dataB$pH*dataB$openwater)
mod18<- glm(dataB$abundance~dataB$pH*dataB$conductivity)
...
AIC(mod12)
AIC(mod13)
AIC(mod14) #### Chicken dinner  #####
AIC(mod15) #### Chicken dinner  #####
AIC(mod16)
AIC(mod17)
AIC(mod18)
```
...
library(ggplot2)
library(ggrepel)
nymphabund <- ggplot(dataB, aes(x=openwatersizem2, y=abundance)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Abundance") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
...
nymphrich <- ggplot(dataB, aes(x=openwatersizem2, y=richness)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Richness") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
nymphrich + 
  geom_label_repel(aes(label = ID),
                  box.padding   = 0.35, 
                  point.padding = 0.5,
...
dataB$openwatersizem2 <- as.factor(dataB$openwatersizem2)
head(dataB)
p <- ggplot(dataB, aes(x=openwatersizem2, y=nondragonflyabundance)) + 
  geom_violin()
p
