...
modA1<-glm(adjusted.abundance  ~  pH, data= dataA, family = poisson(link="log"))
modA2<-glm(adjusted.abundance ~ elevation, data= dataA,family = poisson(link="log"))
modA3<-glm(adjusted.abundance ~ fishpresence, data= dataA,family = poisson(link="log"))
modA4<-glm(adjusted.abundance ~ lenticlotic,data= dataA, family = poisson(link="log"))  
modA5<-glm(adjusted.abundance ~ openwater, data= dataA,family = poisson(link="log"))
modA6<-glm(adjusted.abundance ~ pH*elevation*fishpresence*lenticlotic*openwater,data= dataA, family = poisson(link="log"))
modA7<-glm(adjusted.abundance ~ 1,data= dataA, family = poisson(link="log"))


modAR1<-glm(Richness  ~  pH + offset(adulteffort), data= dataA, family = poisson(link="log"))
modAR2<-glm(Richness ~ elevation + offset(adulteffort), data= dataA,family = poisson(link="log"))
modAR3<-glm(Richness ~ fishpresence + offset(adulteffort), data= dataA,family = poisson(link="log"))
modAR4<-glm(Richness ~ lenticlotic + offset(adulteffort),data= dataA, family = poisson(link="log"))  
modAR5<-glm(Richness ~ openwater + offset(adulteffort), data= dataA,family = poisson(link="log"))
modAR6<-glm(Richness ~ pH*elevation*fishpresence*lenticlotic*openwater + offset(adulteffort),data= dataA, family = poisson(link="log"))
modAR7<-glm(Richness ~ 1,data= dataA, family = poisson(link="log"))

# make list of models
modelsA <- list(modA1, modA2, modA2, modA4, modA5, modA6, modA7)
# names of models
mod_namesA <- c("pH",
"elevation",
"fish",
...
# make list of models
modelsAR <- list(modAR1, modAR2, modAR3, modAR4, modAR5, modAR6, modAR7)
# names of models
mod_namesAR <- c("pH",
"elevation",
"fish",
...
### Each possible combination of variables needs to be analyzed.  The lowest score (not counting the full model?) wins. #####
modB1<-glm(abundance ~ pH + offset(areasampled), data= dataB, family = poisson(link="log"))
modB2<-glm(abundance ~ elevation + offset(areasampled), data= dataB, family = poisson(link="log"))
modB3<-glm(abundance ~ fishpresence + offset(areasampled), data= dataB, family = poisson(link="log"))
modB4<-glm(abundance ~ lenticlotic + offset(areasampled), data= dataB, family = poisson(link="log"))
modB5<-glm(abundance ~ openwatersizem2 + offset(areasampled), data= dataB, family = poisson(link="log"))
modB6<-glm(abundance ~ pH*elevation*fishpresence*lenticlotic*openwatersizem2 + offset(areasampled), data= dataB, family = poisson(link="log"))

modB7 <- glm(richness ~ pH + offset(areasampled), data= dataB, family = poisson(link="log"))
modB8 <- glm(richness ~ elevation + offset(areasampled), data= dataB, family = poisson(link="log"))
modB9 <- glm(richness ~ fishpresence + offset(areasampled), data= dataB, family = poisson(link="log"))
modB10 <- glm(richness ~ lenticlotic + offset(areasampled), data= dataB, family = poisson(link="log"))
modB11 <- glm(richness ~  openwatersizem2 + offset(areasampled), data= dataB, family = poisson(link="log"))
modB12 <- glm(richness ~  pH*elevation*fishpresence*lenticlotic*openwatersizem2 + offset(areasampled), data= dataB, family = poisson(link="log"))

# make list of models
modelsB <- list(modB1, modB2, modB2, modB4, modB5, modB6)
# names of models
mod_namesB <- c("pH",
"elevation",
"fish",
...
p <- ggplot() +
      ...
      # red plot
      geom_point(data=dataB, aes(x=openwatersizem2, y=abundance), fill="red", colour="red", size=1)
p
```
