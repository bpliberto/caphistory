...
modAR7
1 - (87.91/87.91)
rsq(modAR7,adj=FALSE,type=c('v','kl','sse','lr','n'),data=dataA) # so this thing is telling me that the r^2 value for this is 0......which would mean this isn't explaining any of the variance in the data? so then how does it have the lowest AIC?
```
