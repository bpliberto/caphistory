...
modB14 <-glm(abundance ~ pH +elevation, data= dataB, family = poisson(link="log"), offset(areasampled))
...
modBR14 <-glm(richness ~ pH +elevation, data= dataB, family = poisson(link="log"), offset(areasampled))
...
# make list of models
modelsB <- list(modB7, modB8, modB9, modB10, modB12, modB14)
# names of models
...
# make list of models
modelsBR <- list(modBR7, modBR8,modBR9, modBR10, modBR12, modBR14)
# names of models
