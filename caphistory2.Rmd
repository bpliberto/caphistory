...
invertdensity <- ggplot(dataF, aes(x=otherinvertsdensity, y=larvaldensity)) + geom_point() + xlab("Other Invertebrates Density") + ylab("Larval Density") + geom_text(aes(label=ID),hjust=.5, vjust=1.5)
invertdensity
