...
library(rsq)
rsq(modA6,adj=FALSE,type=c('v','kl','sse','lr','n'),data=dataA) #this is supposed to give me the r^2 values for glms

rsq(modAR6,adj=FALSE,type=c('v','kl','sse','lr','n'),data=dataA) # so this thing is telling me that the r^2 value for this is 0......which would mean this isn't explaining any of the variance in the data? so then how does it have the lowest AIC?
```
