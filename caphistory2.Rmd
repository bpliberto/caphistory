...
```{r}
library(ggplot2)
adultabund <- ggplot(dataA, aes(x=openwater, y=adjusted.abundance)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Adult Abundance") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)


adultrich <- ggplot(dataA, aes(x=openwater, y=Richness)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Adult Richness") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
...
modB12 <- glm(larvaldensity ~ chirodensity)
...
```{r}
library(ggplot2)
nymphabund <- ggplot(dataB, aes(x=openwatersizem2, y=abundance)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Nymph Abundance") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)


nymphrich <- ggplot(dataB, aes(x=openwatersizem2, y=richness)) + geom_point() + xlab("Area of Open Water" ~m^2) + ylab("Nymph Richness") #+ geom_text(aes(label=ID),hjust=.5, vjust=1.5)
