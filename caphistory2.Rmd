...
rsq(modB6,adj=FALSE,type=c('v','kl','sse','lr','n'),data=dataB) #this is supposed to give me the r^2 values for glms
summary(modB6)

modBR6

rsq(modBR6,adj=FALSE,type=c('v','kl','sse','lr','n'),data=dataB)
