...
adultabundp <- ggplot(dataA, aes(x=pH, y=adjusted.abundance)) + geom_point() + xlab("pH") + ylab("Adult Abundance")


adultrichp <- ggplot(dataA, aes(x=pH, y=adjusted.richness)) + geom_point() + xlab("pH") + ylab("Adult Richness")
