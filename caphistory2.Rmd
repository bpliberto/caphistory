...
# make list of models
modelsA <- list(modA1, modA2, modA2, modA4, modA5, modA6, modA7, modA8, modA9, modA10)
# names of models
mod_namesA <- c("pH",
"elevation",
"fish",
...
# make list of models
modelsAR <- list(modAR1, modAR2, modAR3, modAR4, modAR5, modAR6, modAR7, modAR8, modAR9, modAR10)
# names of models
mod_namesAR <- c("pH",
"elevation",
"fish",
...
modBR6 <- glm(richness ~  pH+elevation+fishpresence+lenticlotic+openwatersizem2, data= dataB, family = poisson(link="log"), offset(areasampled))
...
# make list of models
modelsB <- list(modB6, modB7, modB8, modB9, modB10, modB11)
# names of models
mod_namesB <- c("pH elevation fish lenticlotic openwater",
"elevation-fish",
"pH-fish",
"ph-openwater",
"y=1",
...
# names of models
mod_namesBR <- c("pH elevation fish lenticlotic openwater",
"elevation-fish",
"pH-fish",
"pH-openwater",
"y=1")
