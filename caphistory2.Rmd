...
mark(marked_dfNMBS, model.parameters=list(p=list(formula=~1)),output=FALSE, time.intervals = c(23, 4, 9, 2, 4, 15, 9, 1, 2, 7, 9))$results$beta

mark(marked_dfNMBS, model = "Jolly", model.parameters=list(p=list(formula=~1)),output=FALSE,time.intervals = c(23, 4, 9, 2, 4, 15, 9, 1, 2, 7, 9))$results$beta
```
...
```{r}
MarkPath='C:/Program Files (x86)/MARK'
mark(marked_dfCT, model.parameters=list(p=list(formula=~1)),output=FALSE,time.intervals = c(7, 8, 6, 7, 4, 9, 3, 7) )$results$beta

mark(marked_dfCT, model = "Jolly", model.parameters=list(N=list(formula=~1)),output=FALSE, time.intervals = c(7, 8, 6, 7, 4, 9, 3, 7))$results$beta
