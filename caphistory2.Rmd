...
modB6<-glm(abundance ~ pH*elevation*fishpresence*lenticlotic*openwatersizem2, data= dataB, family = poisson(link="log"), offset(areasampled))

modB7 <- glm(richness ~ pH , data= dataB, family = poisson(link="log"), offset(areasampled))
modB8 <- glm(richness ~ elevation, data= dataB, family = poisson(link="log"), offset(areasampled))
modB9 <- glm(richness ~ fishpresence, data= dataB, family = poisson(link="log"), offset(areasampled))
modB10 <- glm(richness ~ lenticlotic, data= dataB, family = poisson(link="log"), offset(areasampled))
modB11 <- glm(richness ~  openwatersizem2, data= dataB, family = poisson(link="log"), offset(areasampled))
modB12 <- glm(richness ~  pH*elevation*fishpresence*lenticlotic*openwatersizem2, data= dataB, family = poisson(link="log"), offset(areasampled))
