...
modA13<-glm(Abundance ~ airtempdiff, data= dataA,family = poisson(link="log"), offset(adulteffort))
...
modAR13<-glm(Richness ~ airtempdiff, data= dataA,family = poisson(link="log"), offset(adulteffort))
...
# make list of models
modelsA <- list(modA1,modA2, modA3, modA4, modA5, modA13)
# names of models
mod_namesA <- c("ph",
                "elevation",
                "fish",
...
#looking at super simple models
# make list of models
modelsA <- list(modAR1,modAR2, modAR3, modAR4, modAR5, modAR13)
# names of models
mod_namesA <- c("ph",
                "elevation",
                "fish",
