...
mod4<-glm(data$adjusted.abundance~data$lenticlotic)  #### Chicken dinner  #####
...
mod14<-glm(data$adjusted.abundance~data$fishpresence*data$openwater)
mod15<-glm(data$adjusted.abundance~data$fishpresence*data$lenticlotic*data$openwater)
