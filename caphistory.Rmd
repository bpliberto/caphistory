...
Also, antoher reason it might not be working for each individual location is because there aren't very many marks, so maybe the CJS/JS where I look at locations and species are good enough, although I am worried that lumping all locations together isn't really giving me what I want. The reason I wanted to split them is because the models assume there is not emigration, so it seems silly to have a bunch of locations together.
